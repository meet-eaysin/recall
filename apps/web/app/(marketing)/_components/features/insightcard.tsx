...
const InsightCard = () => {
  return (
    ...
    >
      <div className="absolute bottom-0 left-4 h-32 w-56 -rotate-2 rounded-t-md bg-linear-to-br from-neutral-800/40 to-neutral-800/70 px-4 py-3">
      ...
      <div className="absolute left-[31.6rem] top-[4.4rem] h-50 w-[20.3rem] rotate-2 rounded-t-md bg-linear-to-br from-neutral-800/40 to-neutral-900/80">
