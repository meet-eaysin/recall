    ...
    >
      <motion.div
        ...
        className={cn(
          ...
          'top-[80px] h-32 w-[98%] max-w-[20rem] p-6',
          'border-t border-neutral-700/70 bg-linear-to-b from-neutral-800 to-neutral-950 text-white shadow-lg',
        )}
        style={{
          clipPath:
      ...
      <motion.div
        ...
        className={cn(
          'absolute inset-x-0 mx-auto',
          'top-[40px] flex h-18 w-18 items-center justify-center overflow-hidden rounded-full bg-neutral-950 p-1',
        )}
      >
        <motion.div
          variants={shineVariant}
          className="absolute left-1/2 top-0 h-full w-10 rounded-full bg-[linear-gradient(90deg,transparent,--theme(--color-white/50%)_30%,white,--theme(--color-white/50%)_70%,transparent)] opacity-30"
        />
        <motion.div
      ...
      <motion.div
        variants={vaultVariant}
        className="absolute inset-x-0 top-[40px] mx-auto flex h-18 w-18 items-center justify-center overflow-hidden rounded-full border-b-[3px] border-neutral-700/70"
      />
      <motion.div
...
export default FeatureVaultLock;
