...
const CtaIcon = () => {
  return (
    <div className="perspective-[400px] transform-3d">
      <div
        className="relative mx-auto h-14 w-14 rounded-md bg-linear-to-b from-neutral-800 to-neutral-950 p-[4px]"
      ...
      >
        <div className="relative z-20 flex h-full w-full items-center justify-center overflow-hidden rounded-[5px] bg-black">
          <HiOutlineChartBar className="h-6 w-6 text-cyan-500" />
        </div>
        ...
        <div className="absolute inset-x-0 bottom-0 mx-auto h-[8px] w-[60%] bg-linear-to-r from-transparent via-cyan-600 to-transparent blur-sm" />
      </div>
    </div>
  );
};
